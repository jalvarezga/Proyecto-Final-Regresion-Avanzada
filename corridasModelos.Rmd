...
#-Defining inits-
#MODIFICAR
inits2<-function(){list(beta=rep(0,28),tau=1,w=rep(0,n-m),tau.w=1,phi=1,yf1=rep(0,n-m),wf=rep(0,m),yf2=rep(0,m))}
...
for (i in 1:n) {
	y[i] ~ dnorm(mu[i],tau)
	mu[i]<-w[i]+beta[1]+beta[2]*x[i,1]+beta[3]*x[i,2]+beta[4]*x[i,3]+beta[5]*x[i,4]+beta[6]*x[i,5]+beta[7]*x[i,6]+ beta[8]*x[i,7]+beta[9]*x[i,8]+beta[10]*x[i,9]+beta[11]*x[i,10]+beta[12]*x[i,11]+beta[13]*x[i,12]+beta[14]*x[i,13]+beta[15]*x[i,14]+beta[16]*x[i,15]+beta[17]*x[i,16]+beta[18]*x[i,17]+beta[19]*x[i,18]+beta[20]*x[i,19]+beta[21]*x[i,20]+beta[22]*x[i,21]+beta[23]*x[i,22]+beta[24]*x[i,23]+beta[25]*x[i,24]+beta[26]*x[i,25]+beta[27]*x[i,26]+beta[28]*x[i,27]+beta[29]*x[i,28]
	w0[i]<-0
	}#MODFICAR--------------------------------------------

#Priors 
for (j in 1:28) { beta[j] ~ dnorm(0,0.001) } #MODIFICAR--------------
...
for (i in 1:m) { 
	yf2[i] ~ dnorm(muf[i],tau) 
	muf[i]<-wf[i]+beta[1]+beta[2]*predx[i,1]+beta[3]*predx[i,2]+beta[4]*predx[i,3]+beta[5]*predx[i,4]+beta[6]*predx[i,5]+beta[7]*predx[i,6]+ beta[8]*predx[i,7]+beta[9]*predx[i,8]+beta[10]*predx[i,9]+beta[11]*predx[i,10]+beta[12]*predx[i,11]+beta[13]*predx[i,12]+beta[14]*predx[i,13]+beta[15]*predx[i,14]+beta[16]*predx[i,15]+beta[17]*predx[i,16]+beta[18]*predx[i,17]+beta[19]*predx[i,18]+beta[20]*predx[i,19]+beta[21]*predx[i,20]+beta[22]*predx[i,21]+beta[23]*predx[i,22]+beta[24]*predx[i,23]+beta[25]*predx[i,24]+beta[26]*predx[i,25]+beta[27]*predx[i,26]+beta[28]*predx[i,27]+beta[29]*predx[i,28]
	w0f[i]<-0
	wf[i] ~ spatial.unipred(w0f[i],s1f[i],s2f[i],w[])
}
...
modelo2.sim <- bugsModel$new(data2, inits2, parameters, modelCode2,n.thin=5, n.iter=10000, n.burnin=1000)
...
metroTren=c(19.4,
            ...
            19.0,
            11.9)
x=cbind(porcentajeUndergrads, PorcentajeMaestria, PorcentajeHispanos, PorcentajerAfroamericanos, PorcentajeMayores, PorcentajeCasados, incomePerCapita, longTravel, metroTren)
x
```
...
#-Defining inits-
inits<-function(){list(beta=rep(0,7),tau.t=1,tau.c=1,theta=rep(0,n),phi=rep(0,n),yf=rep(0,n))}
...
modelo3.sim <- bugsModel$new(data3, inits3, parameters2, modelCode3,n.thin=5, n.iter=10000, n.burnin=1000)
