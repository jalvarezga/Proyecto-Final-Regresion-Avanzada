...
data<-list("n"=n,"y"=y,"x"=x,"s1"=s1[-nAleExc],"s2"=s2[-nAleExc],"m"=m,"s1f"=s1f,"s2f"=s2f,"predx"=nAleExc)
...
for (i in 1:m) { 
	...
	muf[i]<-wf[i]+beta[1]+beta[2]*x[predx[i],1]+beta[3]*x[predx[i],2]+beta[4]*x[predx[i],3]+beta[5]*x[predx[i],4]+beta[6]*x[predx[i],5]+beta[7]*x[predx[i],6]
	w0f[i]<-0
...
#-Defining inits-
#MODIFICAR
inits<-function(){list(beta=rep(0,28),tau=1,w=rep(0,n),tau.w=1,phi=1,yf1=rep(0,n),wf=rep(0,m),yf2=rep(0,m))}
...
for (i in 1:m) { 
	yf2[i] ~ dnorm(muf[i],tau) 
	muf[i]<-wf[i]+beta[1]+beta[2]*x[predx[i],1]+beta[3]*x[predx[i],2]+beta[4]*x[predx[i],3]+beta[5]*x[predx[i],4]+beta[6]*x[predx[i],5]+beta[7]*x[predx[i],6]+ beta[8]*x[predx[i],7]+beta[9]*x[predx[i],8]+beta[10]*x[predx[i],9]+beta[11]*x[predx[i],10]+beta[12]*x[predx[i],11]+beta[13]*x[predx[i],12]+beta[14]*x[predx[i],13]+beta[15]*x[predx[i],14]+beta[16]*x[predx[i],15]+beta[17]*x[predx[i],16]+beta[18]*x[predx[i],17]+beta[19]*x[predx[i],18]+beta[20]*x[predx[i],19]+beta[21]*x[predx[i],20]+beta[22]*x[predx[i],21]+beta[23]*x[predx[i],22]+beta[24]*x[predx[i],23]+beta[25]*x[predx[i],24]+beta[26]*x[predx[i],25]+beta[27]*x[predx[i],26]+beta[28]*x[predx[i],27]+beta[29]*x[predx[i],28]
	w0f[i]<-0
	wf[i] ~ spatial.unipred(w0f[i],s1f[i],s2f[i],w[])
}
...
modelo3.sim <- bugsModel$new(data, inits, parameters, modelCode3,n.thin=5, n.iter=10000, n.burnin=1000)
